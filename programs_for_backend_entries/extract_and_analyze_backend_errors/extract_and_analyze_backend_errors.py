...
def filter_error_lines(infile, known_backend_errors):  
    ...
    error_pattern = r".*(INFO d.f.i.r.p.AbstractProcessor|ERROR).*"
...
def main():
    ...
    """    
    try:
        filter_error_lines(sys.argv[1],  BackendErrors.known_backend_errors) 
